...
EVM withdrawal transactions are persisted locally before fee estimation, signing, or broadcast. The transaction sender atomically claims pending rows, applies dynamic fee caps, and uses EIP-1559 transaction sending.
